...
if __name__ == "__main__":
    ...
    # load model
    # discussion
    with open(join(f"../discussion/checkpoints/{layer_map[LAYER]}_split_method_spatial_layer_{LAYER}_iid_adversial_validation_time_budget_2400", "automl_total.pkl"), "rb") as f:
        automl = pickle.load(f)

    # load feature names
    # discussion
    with open(join(f"../discussion/checkpoints/{layer_map[LAYER]}_split_method_spatial_layer_{LAYER}_iid_adversial_validation_time_budget_2400", "feature_names.pkl"), "rb") as f:
